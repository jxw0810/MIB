...
class Segmentation(object):
    ...
    def default(self, img, expand_dim=1):
        ...
        print("the number of segment image:", num)
        ...
        for idx in range(num):
            idx = cuda(torch.tensor([[idx]], dtype=torch.long), self.is_cuda)  # patch下标idx转为tensor格式
            ...
            # print("idx_all shape:", idx_all.shape)
