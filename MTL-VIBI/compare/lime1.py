...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=6, metavar='N', help='input batch size for training (default: 64)')
    parser.add_argument('--model_name', default='original_BUSI.ckpt', type=str, help= 'if train is True, model name to be saved, otherwise model name to be loaded')
