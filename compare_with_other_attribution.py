...
model_path = 'wights/BUSI_VGG_0.896_0.894.h5'
...
img_path = r"dataset/Dataset_BUSI/test/images/malignant_images/malignant (65).png"
...
african_elephant_output = base_model.output[:, num]
